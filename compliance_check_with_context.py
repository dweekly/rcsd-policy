...
def find_related_policies(policy_code, base_dir='extracted_policies_all'):
    ...
    policy_relationships = {
        ...
        '5131.4': ['0450', '5144', '5144.1', '5144.2', '5131', '5131.2'],  # Student disturbances → Safety plans, Discipline
        '5131': ['5131.4', '5144', '5144.1', '5144.2'],  # Conduct → Related discipline policies
        
        # Food service often relates to wellness
        '3550': ['5030', '3551', '3552', '3553', '3554', '3555'],  # Food service → Wellness, other nutrition
        
        # Safety policies are interconnected
        '0450': ['3515', '3515.5', '3516', '5131.4', '5141.4'],  # Comprehensive safety → Various safety topics
        '3515.5': ['0450', '3515', '4158', '4258', '4358'],  # Sex offender → Safety, employee policies
        ...
        '5145.6': ['6020', '1312.3', '5145.3'],  # Parent involvement → Translation requirements
            ...
            if os.path.exists(file_path):
                try:
                    with open(file_path, 'r') as f:
                        content = f.read(5000)  # Just read enough to get title and overview
...
def check_compliance_with_context(policy_xml, code, title, last_reviewed, related_policies):
...
def main():
    ...
    result = check_compliance_with_context(policy_xml, code, title, last_reviewed, related)
