...
class PDFPolicyParser:
    ...
    def _parse_toc(self, pdf_doc: fitz.Document) -> None:
        ...
        # Pattern for TOC entries (including Bylaw for 9000 series)
        ...
        # Check first 5 pages for TOC (some PDFs have longer TOCs)
    ...
    def _save_documents(self, output_dir: str) -> None:
        ...
        for doc in self.documents:
            ...
            subdir = {
                ...
                'Exhibit': 'exhibits',
                'Bylaw': 'policies'  # Bylaws go in policies directory
